<?php /* Smarty version 2.6.22, created on 2016-01-19 20:00:08
         compiled from header.tpl */ ?>
<!DOCTYPE html><head>

<meta http-equiv="Content-Type" content="text/html; charset=windows-1251" />
<title><?php echo $this->_tpl_vars['title_seo']; ?>
</title>
...
<link href="<?php echo $this->_tpl_vars['templates_patch']; ?>
css/style.css" type="text/css" rel="stylesheet" />
<link href='http://fonts.googleapis.com/css?family=PT+Sans:400,400italic,700,700italic&amp;subset=latin,cyrillic' rel='stylesheet' type='text/css'>
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['templates_patch']; ?>
	    ...
	    <div class="wrap-out">
			<!--<div class="hed-top">
	    		<div class="wrap nuclear">
	    			<a href="/" class="logo"><img src="<?php echo $this->_tpl_vars['templates_patch']; ?>
	  	...
	  	<!--	<div class="slider-wrp">
	  			...
	  			<div class="wrap nuclear">
	  				...
	  				<div class="bxslider">
	  					...
	  					<?php echo $this->_tpl_vars['slider_big']; ?>
	  			...
	  			<div class="wrap nuclear">
	  				...
	  				<div class="sidebar">
	  					...
	  					<div class="category-mnu">
		  					<ul>
		  						<?php echo $this->_tpl_vars['fire_menu']; ?>
		  				...
		  				<div class="news">
		  						...
		  						<a href="/novosti/" class="all">Все новости</a>
		  				     	...
		  				     	<?php echo $this->_tpl_vars['fire_news']; ?>
	  				...
	  				<!--/ sidebar -->
	  				<!-- content <?php echo $this->_tpl_vars['title_seo']; ?>
-->
	  				<div class="content">	
	  					<?php echo $this->_tpl_vars['breads']; ?>