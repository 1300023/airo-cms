...
CKEDITOR.plugins.add('jqueryspellchecker', {
	  ...
	  config: {
	    lang: 'ru,en',        // YANDEX: установите русский и английский €зыки
	    parser: 'html',
	    webservice: {
	      path: 'template/js/jquery-spellchecker-demo-master/webservices/php/SpellChecker.php', // YANDEX: подправьте абсолютный путь
	      driver: 'yandex' // YANDEX: подключите драйвер яндекс.—пеллера
	    },
	    suggestBox: {
	      position: 'below',
	      appendTo: 'body'
